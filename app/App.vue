    ...
    <div id="app">
        <div class="page-layout">
            <b-navbar
                ...
                <div class="container">
                    <b-navbar-brand to="/">
                        <img src="/app/assets/img/logo-smart-dex-chain.png" >
                    </b-navbar-brand>
                    <b-navbar-toggle
                        target="nav-collapse"
                        class="btn-menu-sp"/>
                    <b-collapse
                        ...
                        <b-navbar-nav class="ml-auto navbar-buttons">
                                        ...
                                        <b-dropdown-text v-if="value.event === 'Propose'">
                                            <div>
                                                <span
                                                    ...
                                                    Its time to gather stakes from community by promoting it and
                                        ...
                                        <b-dropdown-text v-if="value.event === 'Withdraw'">
                                            <div>
                                                <span
                                                    ...
                                                    {{ value.amount }} unstaked SDX are ready to withdraw
                                                </span>
                                                <div class="notification__time">SDXMaster -
                                                    {{ value.createdAt }}</div>
                                            </div>
                            ...
                            <b-dropdown
                                ...
                                <b-dropdown-item
                                    target="_bank"
                                    href="https://bit.ly/3qWYeSA">Help</b-dropdown-item>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="tomo-footer__copyright">
                                ...
                                <a
                                    :href="`https://swapdex.gitbook.io/swapdex/changelogs/v${version}`"
                                    class="version-tag">
                                    v{{ version }}</a>
                            </div>
                            <div class="tomo-footer__links">
                                <ul class="list-inline">
                                    <li class="list-inline-item">
                                        <a
                                            target="_blank"
                                            href="https://swapdex.gitbook.io/swapdex/">
...
export default {
    ...
    metaInfo: {
        ...
        meta: [
            { name: 'description', content: 'Smart DEX Chain - Providing a professional UI which allows coin-holders to stake for masternodes, decentralized governance and explore masternode performance statistics' } // eslint-disable-line
        ]
    },
    components: {
        AutoComplete
