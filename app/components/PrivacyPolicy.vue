    ...
    <div class="container">
        <div class="row">
            ...
            <div class="container">
                ...
                <p>
                    Welcome to TomoMaster, a free, open-source, client-side tool for interacting with the blockchain.
                    TomoChain values privacy and we make a concerted effort to minimize and, to the extent possible,
                    eliminate the exposure of personal data during the use of our interface.
                    TomoMaster does not collect, hold, or store keys, account information, or passwords.
                ...
                <p>
                    ...
                    individual to be identified, including, the individual’s name, telephone number, or e-mail address.
                </p>
                <h3
                    style="text-align: center">
                    THE BLOCKCHAIN</h3>
                <p>
                    ...
                    receiver, the amount sent or received, and any other data a user has chosen to include in a given
                    transaction. Information stored on a blockchain may be public, immutable, and difficult or
                ...
                <p>
                    ...
                    any other information that you choose to provide. Also, if you participate in a TomoMaster offer,
                    give-away, or promotion (“Promotion”), you provide your name, e-mail address, and mailing address.
                </p>
                ...
                <p>
                    ...
                    (“Service Providers”). In general, Service Providers will have access to your Personal Information
                    only to the extent needed to perform their business functions but may not use or share that personal
                    information for purposes outside the scope of their functions related to the Services.
                </p>
                ...
                <ol>
                    <li>
                        ...
                        Personal Information about you that we are holding (please note that you are entitled to request
                        one copy of the Personal Information that we hold about you at no cost, but for any further
                        copies, we reservethe right to charge a reasonable fee based on administration costs);
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        on your consent, the right to withdraw that consent and the right to request that we delete or
                        erase your Personal Information from our systems (however, this will not apply if we are
                ...
                <p>
                    ...
                    the type of change. If you object to any changes, you may stop using the Services. Your continued
                    use of the Services after we publish or otherwise provide notice about our changes to the Policy
                    means that you are consenting to the updated Policy.
                </p>
            </div>
        </div>
    </div>
